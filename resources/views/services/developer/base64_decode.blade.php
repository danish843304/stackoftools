...
<div class="converter-container">
  <div class="text-center mb-4">
    <a href="{{ route('base64_encode') }}" id="btnEncode" class="btn btn-switch inactive">Encode Base64</a>
    <button id="btnDecode" class="btn btn-switch active">Decode Base64</button>
  </div>
  <form id="encodeForm">
    ...
    <button type="submit" id="convertBtn" class="btn btn-primary convert-btn">Decode</button>
  </form>
  <div class="mt-4">
